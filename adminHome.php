...
<?php
	...
	if(!$permissionReader->controllaPermesso($permessi, $permissionWriter->segnalazioni('leggi')) || !$permissionReader->controllaPermesso($permessi, $permissionWriter->news('scrivi'))){
		header("Location: index.html");
	}
